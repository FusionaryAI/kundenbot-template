      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        ...
        <div style={{
          ...
          <p style={{ fontSize: "12px", color: "#bbb", marginTop: "4px" }}>
            API-Keys für externe Tools hinterlegen – Leads werden automatisch weitergeleitet.
          </p>
        </div>
        ...
        <div style={{ padding: "24px 28px", maxWidth: "640px", display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ ...sectionStyle, ...revealStyle(0.05) }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "14px" }}>
              <div style={{ width: "32px", height: "32px", borderRadius: "8px", background: "#f0f0f0", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px" }}>
                💬
              </div>
              <div>
            ...
            <div>
              <label style={{ fontSize: "11px", color: "#999", display: "block", marginBottom: "5px", fontWeight: 500 }}>Webhook URL</label>
              <input
                value={slackWebhook}
              ...
              />
              <p style={{ fontSize: "10.5px", color: "#bbb", marginTop: "5px" }}>Einrichten unter: Slack → Apps → Incoming Webhooks</p>
            </div>
          </div>
          ...
          <div style={{ ...sectionStyle, ...revealStyle(0.1) }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "14px" }}>
              <div style={{ width: "32px", height: "32px", borderRadius: "8px", background: "#fff4ee", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px" }}>
                🔶
              </div>
              <div>
            ...
            <div>
              <label style={{ fontSize: "11px", color: "#999", display: "block", marginBottom: "5px", fontWeight: 500 }}>Private App Token</label>
              <input
                value={hubspotKey}
                ...
                onBlur={(e) => e.currentTarget.style.borderColor = "#efefed"}
              />
              <p style={{ fontSize: "10.5px", color: "#bbb", marginTop: "5px" }}>Einrichten unter: HubSpot → Einstellungen → Integrationen → Private Apps</p>
            </div>
          </div>
          ...
          <div style={{ ...sectionStyle, ...revealStyle(0.15) }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "14px" }}>
              <div style={{ width: "32px", height: "32px", borderRadius: "8px", background: "#eef4ff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px" }}>
                🔵
              </div>
              <div>
            ...
            <div>
              <label style={{ fontSize: "11px", color: "#999", display: "block", marginBottom: "5px", fontWeight: 500 }}>API Token</label>
              <input
                value={pipedriveKey}
                ...
                onBlur={(e) => e.currentTarget.style.borderColor = "#efefed"}
              />
              <p style={{ fontSize: "10.5px", color: "#bbb", marginTop: "5px" }}>Einrichten unter: Pipedrive → Einstellungen → Persönliche Einstellungen → API</p>
            </div>
          </div>
